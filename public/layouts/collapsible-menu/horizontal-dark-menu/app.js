            ...
            togglethemeEl.addEventListener('click', function () {
                ...
                if (parseObj.settings.layout.darkMode) {
                    ...
                    if (getUpdatedParseObject.settings.layout.darkMode) {
                        ...
                        if (ifStarterKit) {
                            document.querySelector('.navbar-logo').setAttribute('src', '../<?= base_url("assets/img/".$setting->logo) ?>')
                        } else {
        ...
        AddAnimationClass: function () {
            ...
            getMenus.forEach(menu => {
                if (!menu.classList.contains('menu-heading')) {
                    ...
                    // Pastikan dropMenu tidak null sebelum mengakses propertinya
                    if (dropMenu) {
                    ...
                    // Periksa setiap elemen submenu yang ditemukan
                    subSubmenu.forEach(function (subMenu) {
                        // Pastikan subMenu tidak null sebelum mengakses propertinya
                        if (subMenu) {
